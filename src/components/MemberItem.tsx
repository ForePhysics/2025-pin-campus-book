...
const memberDescriptions: { [key: string]: string } = {
  '笛韵扬': '项目发起人，总负责人',
  '周子涵': '总设计师。实施了原型设计，亚克力打样，PCB拆装打磨，板层装配。',
  '齐一舟': '实施了亚克力打样，PCB拆装打磨',
  '钟奕珈': '实施了和招生办的对接，PCB拆装打磨',
  '钟阅旸': '',
  '陈怡冰': '总开发工程师。实施了esp32嵌入式的开发，网站首页的开发，模块装配，板层装配，质量检测。',
  '汤恭恪': '电子设计工程师，摄影师。实施了PCB电路的设计，焊接，测试，嵌入式开发。',
  '王子琪': '电子设计工程师，实施了PCB电路的设计，焊接，测试，网站部署。',
  '刘禹彤': '',
  '吴瑜青': '交互设计师，专注于用户体验和界面交互设计。',
  '刘翼飞': '软件技术顾问，工业工程顾问，开发工程师，灯光师。实施了奥乐齐的采购，esp32嵌入式辅助开发，模块装配，板层装配，质量检测，网站开发部署。',
  '戴梦瑶': '',
  '张天祺': '实施了模块装配',
  '张雅捷': '实施了模块装配',
  '林弘扬': ''
